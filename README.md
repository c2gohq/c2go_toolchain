...
> `v0.20260809.0-rc.4`, as Git submodules. It is an unsigned evaluation release,
...
The current public candidate is `v0.20260809.0-rc.4`, not a stable release. It is
