...
> `v0.20260809.0-rc.1`, as Git submodules. It is an unsigned evaluation release,
...
The current public candidate is `v0.20260809.0-rc.1`, not a stable release. It is
